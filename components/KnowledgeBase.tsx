  ...
  return (
    <div className="bg-neutral-900 p-6 rounded-xl border border-neutral-800 space-y-4">
      ...
      <div className="flex flex-col gap-3">
        <label className="block text-sm font-medium text-neutral-300">Add Source Material</label>
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium text-neutral-300">Active Context</label>
        <textarea
          value={currentContext}
          onChange={(e) => onContextUpdate(e.target.value)}
          className="w-full h-40 bg-black border border-neutral-800 rounded-lg p-3 text-sm text-neutral-300 focus:border-white focus:outline-none transition-colors"
